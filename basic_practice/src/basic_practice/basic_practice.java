...
public class basic_practice {
    ...
    static void showDirectedGraph() {
        ...
        String type = "gif";
        File out = new File("E:\\ming\\out1." + type);    // Windows
    ...
    static String calcShortestPath(String startNode, String endNode) {
        ...
        // System.out.println(gv.getDotSource());
        String type = "gif";
        File out = new File("E:\\ming\\out2." + type);    // Windows
        gv.writeGraphToFile(gv.getGraph(gv.getDotSource(), type), out);
    ...
    static String randomWalk() {
        ...
        // System.out.println(gv.getDotSource());
        String type = "gif";
        File out = new File("E:\\ming\\out3." + type);    // Windows
        gv.writeGraphToFile(gv.getGraph(gv.getDotSource(), type), out);
        return overWords;
    }
}
...
class preNode {
    ...
    preNode(String preNodeStr, int nodeStep) {
