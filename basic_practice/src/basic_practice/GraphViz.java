...
/**
    ...
    */
   public final int writeGraphToFile(byte[] img, String file)
   {
...
/**
    ...
    */
   private byte[] getimgstream(final File dot, String type)
   {
      File img;
      byte[] imgstream = null;
